  ...
  return (
    <div className='hero-bg relative'>
      ...
      <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
        ...
        <Link to={'/login'} className='text-white bg-red-600 rounded-md py-2 px-3 font-bold'>Sign In</Link>
      </header>
       {/* hero section */}
      <div className='max-w-6xl mx-auto flex items-center justify-center text-center flex-col py-40 text-white'>
        <h1 className='text-4xl md:text-6xl font-bold mb-4'>Unlimited movies, TV shows, and more</h1>
        <p className='text-lg mb-4'>Watch anywhere. Cancel anytime</p>
        <p className='mb-4'>Ready to watch? Enter your email to create or restart your membership.</p>
        <form onSubmit={(e) => handleSubmit(e)} className='flex flex-col md:flex-row gap-4 w-1/2'>
          <input className='p-2 rounded flex-1 bg-black/80 border border-gray-700'
          type="email"
          ...
          />
          <button className='bg-red-600 p-3 text-xl lg:text-2xl px-2 lg:px6 py-1 md:py-2 rounded flex justify-center items-center'>
            Get Started
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto md:flex-row items-center flex-col px-4 md:px-2'>
          {/* left side */}
      ...
      {/*2nd section */}
      <div className='py-10 bg-black text-white'>
        <div className='max-w-6xl mx-auto flex flex-col-reverse items-center justify-center md:flex-row px-4 md:px-2'>
          {/* left side */}
          <div className='flex-1'>
            <div className='relative'>
              <img className='mt-4' src='stranger-things-lg.png' alt='Stranger things image'/>

              <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:1/2 h-24 border border-slate-500 rounded-md px-2'>
                <img src="stranger-things-sm.png" alt="Image" className='h-full'  />
                <div className='flex justify-between items-center w-full'>
                <div className='flex flex-col gap-0'>
                  <span className='font-bold text-md lg:text-lg'>Sreanger Things</span>
          ...
          {/* right side */}
          <div className='flex-1 ms:text-left text-center'>
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto md:flex-row items-center flex-col px-4 md:px-2'>
          ...
          <div className='flex-1 relative overflow-hidden'>
            ...
            <video className='absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 h-4/6 z-10 max-w-[63%]'
            playsInline
            autoPlay={true}
            muted
            loop
